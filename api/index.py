    ...
    if is_admin(user_id):
        if text == "/start" or text == "/help":
            ...
            _send_msg(
                ...
                f"💡 <i>Чтобы изменить автоприём или добавить админов, отредактируйте переменные окружения в Vercel.</i>"
            )
            return
